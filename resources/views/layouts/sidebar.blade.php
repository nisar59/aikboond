...
<div class="main-sidebar sidebar-style-2">
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
      ...
      @can('union-councils.view')
      <li class="menu-header">Union councils </li>
      <li class="dropdown @if($pref=='/union-councils') active @endif">
        <a href="{{url('/union-councils')}}" class="nav-link"><i class="far fa-building"></i><span>Union councils </span></a>
      </li>
      @endcan
